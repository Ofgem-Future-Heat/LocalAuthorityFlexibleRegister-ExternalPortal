...
namespace Ofgem_Web_LAF_ExternalPortal.Models
{
    public class ThreePartDateNullable
    {
        ...
        {
            if ((Day is null or 0) && (Month is null or 0) && (Year is null or 0))
            {
                HasError = true;
                HasDayError = true;
                HasMonthError = true;
            ...
            if ((Day is null or 0) && (Month is null or 0) || (Day is null or 0) && (Year is null or 0) || (Month is null or 0) && (Year is null or 0))
            {
                HasError = true;
                HasDayError = true;
                HasMonthError = true;
